...
import cn.apimix.api.mapper.ApiParamMapper;
import cn.apimix.api.model.entity.ApiParam;
import cn.apimix.api.model.entity.table.ApiParamTableDef;
import cn.apimix.api.service.ApiParamService;
...
public class ApiParamServiceImpl extends ServiceImpl<ApiParamMapper, ApiParam> implements ApiParamService {
    ...
    public List<ApiParam> selectApiParamByApiId(Long apiId) {
        ...
        queryWrapper.where(ApiParamTableDef.API_PARAM.API_VERSION_ID.eq(apiId));
        // 查询顶级ID

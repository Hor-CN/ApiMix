...
public class RedisUtils {
    ...
    public static <T> void set(String key, T value, Duration duration) {
        CLIENT.getBucket(key).set(value, duration.toMinutes(), TimeUnit.MINUTES);
    }
    ...
    public static String formatKey(String... subKeys) {
        return String.join(StrPool.COLON, ArrayUtil.removeBlank(subKeys));
    }
}

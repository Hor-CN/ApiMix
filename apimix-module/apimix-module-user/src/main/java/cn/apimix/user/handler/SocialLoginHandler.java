...
import cn.apimix.user.model.req.SocialLoginReq;
...
import cn.apimix.user.service.UserRoleService;
...
public class SocialLoginHandler extends AbstractLoginHandler<SocialLoginReq> {
    ...
    public LoginResp login(SocialLoginReq req, HttpServletRequest request) {
        ...
        if (null == userSocial) {
            ...
            // 每个用户创建一个独立的密码加密盐值
            String salt = SecureUtil.md5(Arrays.toString(RandomUtil.randomBytes(6)));

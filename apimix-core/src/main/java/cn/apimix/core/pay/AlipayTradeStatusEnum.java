...
public enum AlipayTradeStatusEnum {
    ...
    private final PayStatusEnum payStatusEnum;

    AlipayTradeStatusEnum(PayStatusEnum orderStatusEnum) {
        this.payStatusEnum = orderStatusEnum;
    }
    ...
    public static Integer getState(PayStatusEnum payStatusEnum) {
